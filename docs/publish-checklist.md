...
**Latest:** `0.3.0` — [v0.3.0](https://github.com/hideyukiMORI/nene2-node/releases/tag/v0.3.0) (2026-05-29). Releases are cut at checkpoints via a GitHub Release (OIDC publish); see `docs/development/release-process.md`. npm history skips `0.1.24`/`0.1.25` (tagged, never published).
