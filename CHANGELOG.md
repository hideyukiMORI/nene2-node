...
> **Release note:** `0.1.26` ships everything since `0.1.23`. The `0.1.24` and
> `0.1.25` sections below were tagged but **never published** (no GitHub Release
> was created), so npm jumps `0.1.23 → 0.1.26`. See
